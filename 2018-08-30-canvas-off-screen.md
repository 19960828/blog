...
如何借助`canvas`实现一个简单实用的放大镜？

> 一起来玩一下`canvas`的离屏技术吧！
...
![](/images/JavaScript/canvas离屏技术与放大镜实现/1.png)

拖动滑竿，即可放大和缩小图像。然后右键保存图像。保存后的图像，就有已经有了水印，如下图所示：

![](/images/JavaScript/canvas离屏技术与放大镜实现/2.png)
...
![](/images/JavaScript/canvas离屏技术与放大镜实现/3.png)
